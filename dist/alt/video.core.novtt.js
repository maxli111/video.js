...
(function (global, factory) {
  ...
  function one(elem, type, fn) {
    ...
    _func.guid = fn.guid = fn.guid || newGUID();
    on(elem, type, _func);
  }
  ...
  function any(elem, type, fn) {
    var _func2 = function func() {
      off(elem, type, _func2);
      fn.apply(this, arguments);
    };

    // copy the guid to the new function so it can removed using the original function's ID
    _func2.guid = fn.guid = fn.guid || newGUID();
  ...
  *         The evented object we are validating for
  ...
  var EventedMixin = {
    ...
    one: function one() {
      ...
      if (isTargetingSelf) {
        ...
        var _wrapper = function wrapper() {
          _this2.off(target, type, _wrapper);
        ...
        // Use the same function ID as the listener so we can remove it later
        // it using the ID of the original listener.
        _wrapper.guid = listener.guid;
        listen(target, 'one', type, _wrapper);
      }
    },
    /**
     * Add a listener to an event (or events) on this object or another evented
    ...
    any: function any() {
      ...
      if (isTargetingSelf) {
        ...
        var _wrapper2 = function wrapper() {
          _this3.off(target, type, _wrapper2);
        ...
        // Use the same function ID as the listener so we can remove it later
        // it using the ID of the original listener.
        _wrapper2.guid = listener.guid;
        listen(target, 'any', type, _wrapper2);
      }
    },
    /**
  ...
  var ModalDialog = /*#__PURE__*/function (_Component) {
    ...
    _proto.closeable = function closeable(value) {
      if (typeof value === 'boolean') {
        var _closeable = this.closeable_ = !!value;
  ...
  var TextTrack = /*#__PURE__*/function (_Track) {
    ...
    function TextTrack(options) {
      ...
      var changed = false;
      _this.timeupdateHandler = bind(_this, function (event) {
        if (event === void 0) {
          event = {};
        }
   ...
   * @private
   */
  var _filterSource = function filterSource(src) {
    // traverse array
    if (Array.isArray(src)) {
      var newsrc = [];
      src.forEach(function (srcobj) {
        srcobj = _filterSource(srcobj);
  ...
  var ProgressControl = /*#__PURE__*/function (_Component) {
    ...
    function ProgressControl(player, options) {
      var _this;
      _this = _Component.call(this, player, options) || this;
      _this.handleMouseMove = throttle(bind(_this, _this.handleMouseMove), UPDATE_REFRESH_INTERVAL);
      _this.throttledHandleMouseSeek = throttle(bind(_this, _this.handleMouseSeek), UPDATE_REFRESH_INTERVAL);
  ...
  var VolumeControl = /*#__PURE__*/function (_Component) {
    ...
    function VolumeControl(player, options) {
      ...
      _this.throttledHandleMouseMove = throttle(bind(_this, _this.handleMouseMove), UPDATE_REFRESH_INTERVAL);
      _this.handleMouseUpHandler_ = function (e) {
        return _this.handleMouseUp(e);
      };
      _this.on('mousedown', function (e) {
  ...
  var TextTrackSettings = /*#__PURE__*/function (_ModalDialog) {
    ...
    function TextTrackSettings(player, options) {
      ...
      _this = _ModalDialog.call(this, player, options) || this;
      _this.updateDisplay = _this.updateDisplay.bind(_this);
  ...
  var Html5 = /*#__PURE__*/function (_Tech) {
    ...
    */
    ...
    _proto.restoreMetadataTracksInIOSNativePlayer_ = function restoreMetadataTracksInIOSNativePlayer_() {
      ...
      var _restoreTrackMode = function restoreTrackMode() {
      ...
      this.on('webkitbeginfullscreen', function () {
        ...
        textTracks.removeEventListener('change', _restoreTrackMode);
        textTracks.addEventListener('change', _restoreTrackMode);
      });
    ...
    _proto.duration = function duration() {
      ...
      if (this.el_.duration === Infinity && IS_ANDROID && IS_CHROME && this.el_.currentTime === 0) {
        ...
        // several with 0
        var _checkProgress = function checkProgress() {
          if (_this5.el_.currentTime > 0) {
            // Trigger durationchange for genuinely live video
            if (_this5.el_.duration === Infinity) {
              _this5.trigger('durationchange');
            }
            _this5.off('timeupdate', _checkProgress);
          }
        };
        this.on('timeupdate', _checkProgress);
        return NaN;
      }
  ...
  var Player = /*#__PURE__*/function (_Component) {
    ...
    _proto.handleTechWaiting_ = function handleTechWaiting_() {
      ...
      var _timeUpdateListener = function timeUpdateListener() {
        if (timeWhenWaiting !== _this8.currentTime()) {
          _this8.removeClass('vjs-waiting');
          _this8.off('timeupdate', _timeUpdateListener);
        }
      };
      this.on('timeupdate', _timeUpdateListener);
    }
    ...
    _proto.handleSrc_ = function handleSrc_(source, isRetry) {
      ...
      var sources = _filterSource(source);
